...
public class StudentDataBase {
    ...
    public static Supplier<Student> studentSupplier = () -> new Student("Adam", 2, 4.0, "male", Arrays.asList(
    ...
    public static List<Student> getAllStudents() {
        ...
        Student student1 = new Student("Adam", 2, 3.6, "male", 10, Arrays.asList("swimming", "basketball",
                "volleyball"));
        Student student2 = new Student("Jenny", 2, 3.8, "female", 11, Arrays.asList("swimming", "gymnastics", "soccer"
        ));
        Student student3 = new Student("Emily", 3, 4.0, "female", 12, Arrays.asList("swimming", "gymnastics",
                "aerobics"));
        ...
        Student student6 = new Student("James", 4, 3.9, "male", 22, Arrays.asList("swimming", "basketball", "baseball"
                , "football"));
    ...
    public static List<Student> getAllStudentsWithNull() {
        ...
        return Arrays.asList(allStudents.get(0),
                allStudents.get(1),
                allStudents.get(2),
                allStudents.get(3),
                allStudents.get(4),
